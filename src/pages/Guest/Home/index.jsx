  ...
  const programs = [
    {
      ...
      description:
        'Master everyday English communication with our comprehensive program.',
      features: [
        'Interactive Classes',
        'Native Speakers',
        'Practical Exercises',
    ...
    },
    {
      ...
      description:
        'Develop professional English skills for the corporate world.',
    ...
    },
    {
      ...
      description:
        'Get ready for IELTS, TOEFL, and Cambridge exams with expert guidance.',
  ...
  const events = [
    {
      ...
      date: '2024-02-15',
      description:
        'Join our interactive speaking workshop and practice with native speakers.',
    },
    {
      id: 2,
        ...
        <div className='relative container mx-auto px-4 h-full flex items-center'>
          <div className='text-white max-w-3xl'>
            <h1 className='text-5xl md:text-6xl font-bold mb-6'>
              Excel in English with Expert Guidance
            </h1>
            <p className='text-xl mb-8'>
              Join our world-class English language programs and unlock your
              potential
            </p>
            <a
              className='bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition duration-300 cursor-pointer'
              href='/course'
            >
              Explore Programs
            </a>
            ...
            <div>
              ...
              <div className='space-y-4'>
                <p className='flex items-center'>
                  <span className='font-bold mr-2'>Address:</span> 85 Nguyễn Văn
                  Nghi, Phường 7, Quận Gò Vấp, TP.HCM
                </p>
                <p className='flex items-center'>
