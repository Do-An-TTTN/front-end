...
const HomePage = () => {
  ...
  const programs = [
    ...
    },
    {
      ...
      features: ['Mock Tests', 'Study Materials', 'Expert Tips'],
  ...
  return (
    <div className='font-sans'>
      ...
      <section className='relative h-screen'>
        ...
        <div className='relative container mx-auto px-4 h-full flex items-center'>
          <div className='text-white max-w-3xl'>
            ...
            <button className='bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition duration-300'>Explore Programs</button>
          </div>
        </div>
      </section>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          <h2 className='text-4xl font-bold text-center mb-16'>Student Testimonials</h2>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
