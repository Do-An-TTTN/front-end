  ...
  const courses = [
    {
      ...
      duration: '12 weeks',
      description:
        'Master complex grammar structures and enhance your writing skills',
      category: 'grammar',
      rating: 4.8,
      popularity: 95,
      price: 299,
    ...
    },
    {
      ...
      duration: '6 weeks',
      description:
        'Expand your vocabulary with practical exercises and real-world contexts',
      category: 'vocabulary',
      rating: 4.7,
      popularity: 92,
      price: 199,
            ...
            {filteredCourses.map((course) => (
              ...
              >
                ...
                <div className='p-6'>
                  ...
                  <Button widthFull>Learn More</Button>
                </div>
              </div>
            ))}
          </div>
